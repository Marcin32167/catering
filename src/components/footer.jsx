                    ...
                    <div className="footer-holder">
                        ...
                        <div className="footer-3-col">
                            ...
                            <div className="footer-card footer-card_end">
                                ...
                                <Link to="/kalkulator-wody" className="footer-link-nav">Kalkulator wody</Link>
                                <a className="footer-link-nav">Link 3</a>
                                <a className="footer-link-nav">Link 4</a>
                            </div>
                            <div className="footer-card footer-card_end">
                            ...
                            <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer"
                               className="social-media-link">
                                <span className="social-media-icon">
                                    <img src={linkedinIcon} alt="ikona linkedin" className="social-icon"/>
                                </span>
                            </a>
                            <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer"
                               className="social-media-link">
                                <span className="social-media-icon">
                                    <img src={facebookIcon} alt="ikona facebook" className="social-icon"/>
                                </span>
                            </a>
                            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                               className="social-media-link">
                                <span className="social-media-icon">
                                    <img src={instagramIcon} alt="ikona instagram" className="social-icon"/>
                                </span>
                            </a>
                        </div>
                    </div>
